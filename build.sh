...
gcc ./HelloShaders/src/interpolation.c lib/*.c -o ./build/Interpolation $(pkg-config --static --libs --cflags glfw3) -I./include/glad/ -Wall -Wextra -Wwrite-strings -std=c11 -ggdb -fsanitize=address
